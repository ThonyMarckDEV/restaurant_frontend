...
import { show, update } from 'services/adicionalService';
...
export const useUpdate = () => {
    ...
    useEffect(() => {
        const loadAdicional = async () => {
            try {
                ...
                setAlert(handleApiError(err, 'No se pudo cargar el adicional.'));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAlert({ type: 'success', message: 'Adicional actualizado correctamente.' });
            setTimeout(() => navigate('/adicional/listar'), 1500);
        } catch (err) {
