...
import { useUpdate } from 'hooks/adicional/useUpdate';
        ...
        <div className="container mx-auto p-6">
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="flex justify-end gap-4">
                    <button type="button" onClick={() => navigate('/adicional/listar')} className="px-6 py-3 bg-slate-100 text-slate-600 rounded-lg font-bold hover:bg-slate-200 uppercase text-sm transition-all">
                        Cancelar
                    </button>
