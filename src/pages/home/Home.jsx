  ...
  return (
    <div className="container mx-auto p-6 min-h-screen"> 
      <div className="max-w-5xl mx-auto">
        ...
        <header className="flex flex-col md:flex-row items-center gap-6 mb-8 p-8 bg-gradient-to-r from-black to-slate-800 rounded-2xl text-white shadow-xl relative overflow-hidden">
          <div className="relative z-10">
            <div className="h-20 w-20 bg-blue-600 rounded-xl flex items-center justify-center text-3xl font-black shadow-inner border border-slate-700 uppercase">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-2">
              <span className="flex items-center gap-1.5 px-3 py-1 bg-white/10 rounded border border-white/10 text-[10px] font-bold uppercase tracking-wider">
                <ShieldCheck size={14} className="text-blue-400"/> {userData?.role || 'Personal'}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-blue-600 p-6 rounded-2xl text-white shadow-lg flex flex-col justify-between relative overflow-hidden">
            <div className="relative z-10">
        ...
        <div className="mt-8 p-8 border border-dashed border-slate-300 bg-slate-50/50 rounded-2xl text-center">
            <p className="text-slate-500 text-sm font-medium italic">
              "El éxito de un restaurante no está en la cocina, sino en el corazón de quienes sirven."
            </p>
            <div className="mt-4 flex items-center justify-center gap-3 opacity-60">
              <span className="h-px w-6 bg-slate-400"></span>
              <p className="text-slate-500 text-[9px] font-black uppercase tracking-[0.2em]">SAAS RESTAURANT</p>
              <span className="h-px w-6 bg-slate-400"></span>
            </div>
        </div>
      </div>
