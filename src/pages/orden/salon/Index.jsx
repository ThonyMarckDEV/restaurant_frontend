// pages/orden/salon/Index.jsx
import React, { useMemo } from 'react';
import { Link } from 'react-router-dom';
import { useIndex } from 'hooks/orden/salon/useIndex';
...
const Index = () => {
    ...
    const filterConfig = useMemo(() => [
        { name: 'fecha', type: 'date', label: 'Fecha', colSpan: 'col-span-12 md:col-span-6' },
        {
    ...
    const getEstadoBadge = (estado) => {
        const badges = {
            1: <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-[10px] font-black border border-blue-200 uppercase tracking-tighter shadow-sm">Abierta</span>,
            2: <span className="bg-emerald-100 text-emerald-700 px-2 py-1 rounded text-[10px] font-black border border-emerald-200 uppercase tracking-tighter shadow-sm">Pagada</span>,
            3: <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-[10px] font-black border border-red-200 uppercase tracking-tighter shadow-sm">Anulada</span>,
        };
    ...
    const columns = useMemo(() => [
        { 
            header: 'N° Orden', 
            render: (row) => <span className="font-bold text-slate-900">#{row.id.toString().padStart(6, '0')}</span> 
        },
    ...
    return (
        <div className="container mx-auto p-4 md:p-6 max-w-7xl">
            ...
            {confirmAction.show && (
                <ConfirmModal 
                    message="¿Estás seguro de ANULAR esta comanda? La mesa se liberará automáticamente y esta acción no se puede deshacer."
